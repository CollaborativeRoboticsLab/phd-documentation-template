...
This repository is intended as a reusable LaTeX template for academic proposals.

- Use it as a GitHub template repository by enabling the template setting.
- Keep the source files in the repository and generate build artifacts in the `build/` folder.
- If you want, add a `.gitignore` to exclude generated files from version control.
